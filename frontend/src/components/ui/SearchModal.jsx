                ...
                <div className="p-6 border-t border-white/10">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <p className="text-white text-sm font-medium">Browse Topics</p>
                      <p className="text-gray-400 text-xs">Explore chemistry discussions</p>
                    </button>
                    <button
                      onClick={() => {
                        navigate('/quizzes')
                      ...
                      className="p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors duration-200 text-left"
                    >
                      <Brain className="w-5 h-5 text-primary-400 mb-2" />
                      <p className="text-white text-sm font-medium">Take Quizzes</p>
                    ...
                    >
                      ...
                      <p className="text-gray-400 text-xs">View your progress</p>
                    </button>
                    <button
                      onClick={() => {
                        navigate('/search')
                    ...
                    >
                      ...
                      <p className="text-white text-sm font-medium">Find Users</p>
                      <p className="text-gray-400 text-xs">Connect with students</p>
                    </button>
                  </div>
                </div>
              )}
