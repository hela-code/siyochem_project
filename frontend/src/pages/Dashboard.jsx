...
const Dashboard = () => {
  ...
  const recentActivity = [
    ...
    {
      type: 'topic',
      title: 'Posted in Chemical Bonding Discussion',
      description: 'Shared insights on covalent bonds',
      time: '5 hours ago',
      icon: BookOpen
    },
    {
      type: 'achievement',
      title: 'Earned "Chemistry Expert" Badge',
      description: 'Completed 10 quizzes with 80%+ scores',
      time: '1 day ago',
      icon: Award
    }
  ]
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <p className="text-gray-300">
          Ready to continue your chemistry journey? Here's your learning dashboard.
        </p>
      </motion.div>
