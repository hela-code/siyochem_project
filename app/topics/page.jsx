...
const mockTopics = [
  ...
  },
  {
    ...
    author: { name: 'Dr. Kumar' },
    category: 'Organic Chemistry',
    tags: ['reactions', 'mechanisms', 'study-group'],
    stats: { likes: 89, posts: 67, views: 423 },
    isPinned: false,
  ...
  },
  {
    ...
    stats: { likes: 34, posts: 18, views: 201 },
    isPinned: false,
    createdAt: '1 day ago',
  },
]
          ...
          >
            <Link href={`/topics/${topic.id}`}>
              ...
              <div className="flex items-center space-x-4 text-gray-400 text-sm">
                <span className="flex items-center"><Heart className="w-4 h-4 mr-1" />{topic.stats.likes}</span>
                <span className="flex items-center"><MessageCircle className="w-4 h-4 mr-1" />{topic.stats.posts}</span>
                <span className="flex items-center"><Eye className="w-4 h-4 mr-1" />{topic.stats.views}</span>
              </div>
            </Link>
          </motion.div>
        ))}
